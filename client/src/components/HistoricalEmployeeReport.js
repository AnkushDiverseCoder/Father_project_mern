...
import EmployeeEnrollmentReport from "./EmployeeEnrollmentReport";
import { HistoricalEmployeeReport, verifyToken } from "../utils/ApiRoutes";
...
const HistoricalReport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await axios.post(HistoricalEmployeeReport, {
      startDateFormated,
      endDateFormated,
    });
