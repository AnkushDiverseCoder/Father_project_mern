...
const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© FinanceManager —
      <Link href="https://twitter.com/knyttneve" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@Ankush Thakur</Link>
    </p>
